...
namespace MVC_Projekt_Elearning.Services
{
    public class InstructorService : IInstructorService
    {
        ...
        {
            return await _context.Instructors.Include(m => m.InstructorSosials).ToListAsync();
        }
        ...
        {
            return await _context.Instructors.Include(m => m.InstructorSosials).FirstOrDefaultAsync(m => m.Id == id);
        }
    }
}
