...
using MVC_Project_ELearning.ViewModels.Instructors;
using MVC_Project_ELearning.ViewModels.Socials;
...
namespace MVC_Projekt_Elearning.Areas.Admin.Controllers
{
    ...
    public class InstructorController : Controller
    {
        ...
        public async Task<IActionResult> Create(InstructorCreateVM request)
        {
            ...
            await _instructorService.CreateAsync(new Instructor {Image = fileName, Email = request.Email, Designation = request.Designation });
        ...
        public async Task<IActionResult> AddSocial(int? id, SocialCreateVM request)
        {
            ...
            var social = new InstructorSosial { InstructorId = (int)id, SosialId = request.SocialId, SosialLink = request.URl };
            await _context.InstructorSosials.AddAsync(social);
